...
<div id="addAll">
        ...
        function fileChange() {//注意：此处不能使用jQuery中的change事件，因此仅触发一次，因此使用标签的：onchange属性
            ...
            $.ajaxFileUpload({
                ...
                success: function (result) //服务器成功响应处理函数
                {
                    ...
                    var imgObj = $("<img>");
                    //给img标签对象追加属性
                    imgObj.attr("src", "/image_big/" + result.imgurl);
    ...
    <div id="table">
        <form action="${pageContext.request.contextPath}/prod/update" enctype="multipart/form-data" method="post"
              id="myform">
...
<%--                        <span id="imgName">${prod.pImage}</span><br>--%>
                    </td>
                </tr>
                <tr class="three">
                    <td class="four"></td>
